...
struct Odometry_
{
    ...
    Odometry_()
        : curodom(), kfodom(), kfid( 0 ), status( 0 )
    {
    }
    Odometry_( const ContainerAllocator &_alloc )
        : curodom( _alloc ), kfodom( _alloc ), kfid( 0 ), status( 0 )
    {
        ( void ) _alloc;
    }
...
// {'nav_msgs': ['/opt/ros/kinetic/share/nav_msgs/cmake/../msg'], 'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg'], 'quadrotor_msgs': ['/home/gf/catkin_ws/src/TOOL_ROS/quadrotor_msgs/msg'], 'geometry_msgs': ['/opt/ros/kinetic/share/geometry_msgs/cmake/../msg'], 'actionlib_msgs': ['/opt/ros/kinetic/share/actionlib_msgs/cmake/../msg']}
...
template < class ContainerAllocator >
struct Serializer<::quadrotor_msgs::Odometry_< ContainerAllocator > >
{
...
struct Printer<::quadrotor_msgs::Odometry_< ContainerAllocator > >
{
    ...
    static void stream( Stream &s, const std::string &indent, const ::quadrotor_msgs::Odometry_< ContainerAllocator > &v )
    {
        s << indent << "curodom: ";
        s << std::endl;
