...
void Parameter_t::config_from_ros_handle( const ros::NodeHandle &nh )
{
    ...
    read_essential_param( nh, "gain/hover/Omega_p_roll", hover_gain.Omega_pid_p_roll );
    read_essential_param( nh, "gain/hover/Omega_p_pitch", hover_gain.Omega_pid_p_pitch );
    read_essential_param( nh, "gain/hover/Omega_p_yaw", hover_gain.Omega_pid_p_yaw);

    read_essential_param( nh, "gain/hover/Omega_d_roll", hover_gain.Omega_pid_d_roll );
    read_essential_param( nh, "gain/hover/Omega_d_pitch", hover_gain.Omega_pid_d_pitch );
    read_essential_param( nh, "gain/hover/Omega_d_yaw", hover_gain.Omega_pid_d_yaw);

    read_essential_param( nh, "gain/hover/ctrl_limit/pos_norm", hover_gain.Ctrl_limit_pos_norm );
    read_essential_param( nh, "gain/hover/ctrl_limit/spd_norm", hover_gain.Ctrl_limit_spd_norm );
    read_essential_param( nh, "gain/hover/ctrl_limit/f_norm", hover_gain.Ctrl_limit_f_norm );
    read_essential_param( nh, "gain/hover/ctrl_limit/switch_angle", hover_gain.Switch_angle );
    ...
    read_essential_param( nh, "gain/track/Omega_p_roll", track_gain.Omega_pid_p_roll );
    read_essential_param( nh, "gain/track/Omega_p_pitch", track_gain.Omega_pid_p_pitch );
    read_essential_param( nh, "gain/track/Omega_p_yaw", track_gain.Omega_pid_p_yaw);

    read_essential_param( nh, "gain/track/Omega_d_roll", track_gain.Omega_pid_d_roll );
    read_essential_param( nh, "gain/track/Omega_d_pitch", track_gain.Omega_pid_d_pitch );
    read_essential_param( nh, "gain/track/Omega_d_yaw", track_gain.Omega_pid_d_yaw);

    read_essential_param( nh, "gain/track/ctrl_limit/pos_norm", track_gain.Ctrl_limit_pos_norm );
    read_essential_param( nh, "gain/track/ctrl_limit/spd_norm", track_gain.Ctrl_limit_spd_norm );
    read_essential_param( nh, "gain/track/ctrl_limit/f_norm", track_gain.Ctrl_limit_f_norm );
    read_essential_param( nh, "gain/track/ctrl_limit/switch_angle", track_gain.Switch_angle );

    read_essential_param( nh, "idling/desired_height_limit",
                          idling.desired_height_limit );
    read_essential_param( nh, "idling/desired_velo_limit",
                          idling.desired_velo_limit ); // 0.01
    read_essential_param( nh, "idling/feedback_velo_limit",
                          idling.feedback_velo_limit ); // 0.1
    ...
    read_essential_param( nh, "idling/landing_thrust_percent",
                          idling.landing_thrust_percent );
    ...
    read_essential_param( nh, "hover/set_hov_percent_to_zero",
                          hover.set_hov_percent_to_zero );
    read_essential_param( nh, "hover/use_hov_percent_kf",
                          hover.use_hov_percent_kf );
    read_essential_param( nh, "hover/vert_velo_limit_for_update",
                          hover.vert_velo_limit_for_update );
    read_essential_param( nh, "hover/vert_height_limit_for_update",
                          hover.vert_height_limit_for_update );
    read_essential_param( nh, "hover/percent_lower_limit",
                          hover.percent_lower_limit );
    read_essential_param( nh, "hover/percent_higher_limit",
                          hover.percent_higher_limit );
