...
bool DJISDKNode::missionStatusCallback(
    dji_sdk::MissionStatus::Request & request,
...
bool DJISDKNode::missionWpUploadCallback(
...
bool DJISDKNode::missionWpActionCallback(
...
bool DJISDKNode::missionWpGetSpeedCallback(
...
bool DJISDKNode::missionWpSetSpeedCallback(
...
bool DJISDKNode::missionWpGetInfoCallback(
...
bool DJISDKNode::missionHpUploadCallback(
...
bool DJISDKNode::missionHpActionCallback(
...
bool DJISDKNode::missionHpGetInfoCallback(
...
bool DJISDKNode::missionHpUpdateYawRateCallback(
    ...
    dji_sdk::MissionHpUpdateYawRate::Response &response )
{
    ...
    if ( vehicle->missionManager->hotptCounter > 0 )
    {
        ack = vehicle->missionManager->hpMission->updateYawRate( yawRate,
                                                                 WAIT_TIMEOUT );
    }
    else
    {
...
bool DJISDKNode::missionHpResetYawCallback(
...
bool DJISDKNode::missionHpUpdateRadiusCallback(
