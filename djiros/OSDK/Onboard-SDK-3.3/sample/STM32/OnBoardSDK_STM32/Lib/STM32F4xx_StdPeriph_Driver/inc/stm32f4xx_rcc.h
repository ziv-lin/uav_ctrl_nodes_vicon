...
#define IS_RCC_I2SCLK_SOURCE(SOURCE)                                           \
  (((SOURCE) == RCC_I2S2CLKSource_PLLI2S) ||                                   \
...
#define IS_RCC_TIMCLK_PRESCALER(VALUE)                                         \
  (((VALUE) == RCC_TIMPrescDesactivated) || ((VALUE) == RCC_TIMPrescActivated))
/**
  * @}
  */
...
#define IS_RCC_AHB1_LPMODE_PERIPH(PERIPH)                                      \
  ((((PERIPH)&0x81906E00) == 0x00) && ((PERIPH) != 0x00))
...
#define IS_RCC_APB2_PERIPH(PERIPH)                                             \
  ((((PERIPH)&0xFFC880CC) == 0x00) && ((PERIPH) != 0x00))
#define IS_RCC_APB2_RESET_PERIPH(PERIPH)                                       \
  ((((PERIPH)&0xFFC886CC) == 0x00) && ((PERIPH) != 0x00))
