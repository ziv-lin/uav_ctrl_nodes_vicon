/**
 ...
 ===============================================================================
    ...
    Digital to Analog conversion can be triggered by:
      (#) External event: EXTI Line 9 (any GPIOx_Pin9) using
 DAC_Trigger_Ext_IT9.
          The used pin (GPIOx_Pin9) must be configured in input mode.

      (#) Timers TRGO: TIM2, TIM4, TIM5, TIM6, TIM7 and TIM8
          (DAC_Trigger_T2_TRGO, DAC_Trigger_T4_TRGO...)
          The timer TRGO event should be selected using
...
/**
  ...
  * @note   When the DAC channel is enabled the trigger source can no more be
 * modified.
  * @retval None
  */
void
...
/**
  ...
  *         TIM2, TIM4, TIM5, TIM6, TIM7 or TIM8  but not a software trigger)
 * occurs.
  * @param  DAC_Channel: The selected DAC channel.
  *          This parameter can be one of the following values:
  *            @arg DAC_Channel_1: DAC Channel1 selected
 ...
 * disabled.
  ...
  * @note   The DMA underrun occurs when a second external trigger arrives
 * before the
  *         acknowledgement for the first external trigger is received (first
 * request).
