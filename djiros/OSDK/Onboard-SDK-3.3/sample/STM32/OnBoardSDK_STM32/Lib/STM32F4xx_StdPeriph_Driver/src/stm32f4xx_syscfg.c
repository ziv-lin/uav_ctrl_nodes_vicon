/**
  ...
  * @brief   This file provides firmware functions to manage the SYSCFG
 peripheral.
  *
 @verbatim
 ...
 SYSCFG_ETH_MediaInterfaceConfig()
       ...
       -@- SYSCFG APB clock must be enabled to get write access to SYSCFG
 registers,
...
/**
  ...
  *            @arg SYSCFG_MemoryRemap_Flash:       Main Flash memory mapped at
 * 0x00000000
  *            @arg SYSCFG_MemoryRemap_SystemFlash: System Flash memory mapped
 * at 0x00000000
  *            @arg SYSCFG_MemoryRemap_FSMC:        FSMC (Bank1 (NOR/PSRAM 1 and
 * 2) mapped at 0x00000000
  *            @arg SYSCFG_MemoryRemap_SRAM:        Embedded SRAM (112kB) mapped
 * at 0x00000000
  * @retval None
  */
void
 ...
 * except
  *           for EXTI_PortSourceGPIOI x can be (0..11) for
