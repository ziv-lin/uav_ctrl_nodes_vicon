...
ENABLE) function
      ...
      (#) Call TIM_TimeBaseInit(TIMx, &TIM_TimeBaseInitStruct) to configure the
Time Base unit
...
/**
  ...
  *            @arg TIM_PSCReloadMode_Update: The Prescaler is loaded at the
 * update event.
...
/**
  ...
  * @param  TIMx: where x can be 1 to 14 except 6 and 7, to select the TIM
 * peripheral.
...
driver,
      ...
      -@- If the corresponding interrupt or DMA request are needed, the user
should:
...
/**
  * @brief  Initializes the TIMx Channel1 according to the specified parameters
 * in
...
channel
          ...
          or duty cycle of the input signal, or, Call TIM_PWMIConfig(TIMx,
&TIM_ICInitStruct)
      ...
      (#) Enable the corresponding interrupt (or DMA request) to read the
Captured
...
/**
  ...
  * @param  TIM_ICInitStruct: pointer to a TIM_ICInitTypeDef structure which
 * will
  *         be initialized.
  * @retval None
  */
...
/** @defgroup TIM_Group4 Advanced-control timers (TIM1 and TIM8) specific
features
...
@verbatim
 ...
 ===============================================================================
    [..]
    After configuring the Timer channel(s) in the appropriate Output Compare
mode:
      ...
      (#) Once the break even occurs, the Timer's output signals are put in
reset
...
/**
  ...
  * @note   TIM_EventSource_COM and TIM_EventSource_Break are used only with
 * TIM1 and TIM8.
  *
  * @retval None
  */
 ...
 * peripheral.
  ...
  *            @arg TIM_DMABase_DCR
  * @param  TIM_DMABurstLength: DMA Burst length. This parameter can be one
 * value
...
/**
  ...
  * @param  TIMx: where x can be 1, 2, 3, 4, 5, 6, 7 or 8 to select the TIM
 * peripheral.
 ...
 * peripheral.
  ...
  *          This parameter can be one of the following values:
  *            @arg TIM_ExtTRGPolarity_Inverted: active low or falling edge
 * active.
  *            @arg TIM_ExtTRGPolarity_NonInverted: active high or rising edge
 * active.
 ...
 * peripheral.
  ...
  *
  *  - For all TIMx
  *            @arg TIM_TRGOSource_Reset:  The UG bit in the TIM_EGR register is
 * used as the trigger output(TRGO)
  *            @arg TIM_TRGOSource_Enable: The Counter Enable CEN is used as the
 * trigger output(TRGO)
  *            @arg TIM_TRGOSource_Update: The update event is selected as the
 * trigger output(TRGO)
  *
  *  - For all TIMx except TIM6 and TIM7
  *            @arg TIM_TRGOSource_OC1: The trigger output sends a positive
 * pulse when the CC1IF flag
  *                                     is to be set, as soon as a capture or
 * compare match occurs(TRGO)
  *            @arg TIM_TRGOSource_OC1Ref: OC1REF signal is used as the trigger
 * output(TRGO)
  *            @arg TIM_TRGOSource_OC2Ref: OC2REF signal is used as the trigger
 * output(TRGO)
  *            @arg TIM_TRGOSource_OC3Ref: OC3REF signal is used as the trigger
 * output(TRGO)
  *            @arg TIM_TRGOSource_OC4Ref: OC4REF signal is used as the trigger
 * output(TRGO)
  *
  * @retval None
  */
 ...
 * peripheral.
  ...
  *          This parameter can be one of the following values:
  *            @arg TIM_SlaveMode_Reset: Rising edge of the selected trigger
 * signal(TRGI) reinitialize
  *                                      the counter and triggers an update of
 * the registers
  *            @arg TIM_SlaveMode_Gated:     The counter clock is enabled when
 * the trigger signal (TRGI) is high
  *            @arg TIM_SlaveMode_Trigger:   The counter starts at a rising edge
 * of the trigger TRGI
  *            @arg TIM_SlaveMode_External1: Rising edges of the selected
...
/**
  ...
  *          This parameter can be one of the following values:
  *            @arg TIM2_TIM8_TRGO: TIM2 ITR1 input is connected to TIM8 Trigger
 * output(default)
  *            @arg TIM2_ETH_PTP:   TIM2 ITR1 input is connected to ETH PTP
 * trogger output.
 ...
 * to TRC.
  ...
  */
static void
TI1_Config(TIM_TypeDef* TIMx, uint16_t TIM_ICPolarity, uint16_t TIM_ICSelection,
 ...
 * to TRC.
  ...
  */
static void
TI2_Config(TIM_TypeDef* TIMx, uint16_t TIM_ICPolarity, uint16_t TIM_ICSelection,
           uint16_t TIM_ICFilter)
{
 ...
 * to TRC.
  ...
  */
static void
TI3_Config(TIM_TypeDef* TIMx, uint16_t TIM_ICPolarity, uint16_t TIM_ICSelection,
           uint16_t TIM_ICFilter)
{
 ...
 * to TRC.
  ...
  */
static void
TI4_Config(TIM_TypeDef* TIMx, uint16_t TIM_ICPolarity, uint16_t TIM_ICSelection,
           uint16_t TIM_ICFilter)
{
  uint16_t tmpccmr2 = 0, tmpccer = 0, tmp = 0;
