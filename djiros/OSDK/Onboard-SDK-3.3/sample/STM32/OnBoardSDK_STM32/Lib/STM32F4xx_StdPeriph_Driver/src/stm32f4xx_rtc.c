/**
  ...
  *           + RTC Tamper and TimeStamp Pins Selection and Output Type Config
configuration
...
@verbatim
 ...
 [..] To allow the RTC to operate even when the main digital supply (VDD) is
turned
...
VDD),
 ...
 [..] When the backup domain is supplied by VBAT (analog switch connected to
VBAT
 ...
 *** Alarm configuration ***
 ...
 [..]
   ...
   (+) To read the RTC alarm SubSecond, use the RTC_GetAlarmSubSecond()
function.
 ...
 *** Outputs configuration ***
 ...
 [..] The RTC has 2 different outputs:
   (+) AFO_ALARM: this output is used to manage the RTC Alarm A, Alarm B
       and WaKeUp signals. To output the selected RTC signal on RTC_AF1 pin, use
the
 ...
 *** Smooth digital Calibration configuration ***
 ================================================
 [..]
   (+) Configure the RTC Original Digital Calibration Value and the
corresponding
       calibration cycle period (32s,16s and 8s) using the
 ...
 *** Tamper configuration ***
 ...
 [..]
   ...
   (+) Configure the RTC Tamper trigger Edge or Level according to the Tamper
       ...
       function.
   (+) Configure the Tamper sampling frequency using
 ...
 *** Backup Data Registers configuration ***
 ===========================================
 [..]
   (+) To write to the RTC Backup Data registers, use the
...
source
 ...
 [..]
   +-------------------------------------------------------------------------------------------------------------+
   |     Pin         |AFO_ALARM |AFO_CALIB |AFI_TAMPER |AFI_TIMESTAMP |
TAMP1INSEL |   TSINSEL    |ALARMOUTTYPE  |
   |  configuration  | ENABLED  | ENABLED  |  ENABLED  |   ENABLED    |TAMPER1
pin |TIMESTAMP pin |  AFO_ALARM   |
   |  and function   |          |          |           |              |
selection  |  selection   |Configuration |
   |-----------------|----------|----------|-----------|--------------|------------|--------------|--------------|
   |   Alarm out     |          |          |           |              |    Don't
|     Don't    |              |
   |   output OD     |     1    |Don't care|Don't care | Don't care   |    care
|     care     |      0       |
   |-----------------|----------|----------|-----------|--------------|------------|--------------|--------------|
   |   Alarm out     |          |          |           |              |    Don't
|     Don't    |              |
   |   output PP     |     1    |Don't care|Don't care | Don't care   |    care
|     care     |      1       |
   |-----------------|----------|----------|-----------|--------------|------------|--------------|--------------|
   | Calibration out |          |          |           |              |    Don't
|     Don't    |              |
   |   output PP     |     0    |    1     |Don't care | Don't care   |    care
|     care     |  Don't care  |
   |-----------------|----------|----------|-----------|--------------|------------|--------------|--------------|
   |  TAMPER input   |          |          |           |              |
|     Don't    |              |
...
|              |              |
   |    floating     |     0    |    0     |     0     |      1       |    care
|      0       |  Don't care  |
   |-----------------|----------|----------|-----------|--------------|------------|--------------|--------------|
   |  Standard GPIO  |     0    |    0     |     0     |      0       | Don't
care |  Don't care  |  Don't care  |
 ...
 [..]
   +---------------------------------------------------------------------------------------+
   |     Pin         |AFI_TAMPER |AFI_TIMESTAMP | TAMP1INSEL |   TSINSEL
|ALARMOUTTYPE  |
   |  configuration  |  ENABLED  |   ENABLED    |TAMPER1 pin |TIMESTAMP pin |
AFO_ALARM   |
   |  and function   |           |              | selection  |  selection
|Configuration |
   |-----------------|-----------|--------------|------------|--------------|--------------|
   |  TAMPER input   |           |              |            |     Don't    | |
   |   floating      |     1     |      0       |      1     |     care     |
...
Don't care  |
   |-----------------|-----------|--------------|------------|--------------|--------------|
   |  Standard GPIO  |     0     |      0       | Don't care |  Don't care  |
Don't care  |
   +---------------------------------------------------------------------------------------+
...
#define RTC_FLAGS_MASK                                                         \
  ((uint32_t)(RTC_FLAG_TSOVF | RTC_FLAG_TSF | RTC_FLAG_WUTF | RTC_FLAG_ALRBF | \
              RTC_FLAG_ALRAF | RTC_FLAG_INITF | RTC_FLAG_RSF |                 \
              RTC_FLAG_INITS | RTC_FLAG_WUTWF | RTC_FLAG_ALRBWF |              \
              RTC_FLAG_ALRAWF | RTC_FLAG_TAMP1F | RTC_FLAG_RECALPF |           \
              RTC_FLAG_SHPF))
...
RTC
      Prescaler (Synchronous and Asynchronous), RTC Hour format, disable RTC
registers
      Write protection, enter and exit the RTC initialization mode, RTC
registers
...
initialization
       ...
       updated. When the initialization sequence is complete, the calendar
restarts
       counting after 4 RTCCLK cycles.

   (#) To read the calendar through the shadow registers after Calendar
initialization,
       calendar update or after wakeup from low power modes the software must
first
       clear the RSF flag. The software must then wait until it is set again
before
...
RTC_SetTime(uint32_t RTC_Format, RTC_TimeTypeDef* RTC_TimeStruct)
{
  ...
  {
    tmpreg =
      (uint32_t)(((uint32_t)RTC_ByteToBcd2(RTC_TimeStruct->RTC_Hours) << 16) |
  ...
  else
  {
    ...
    /* If  RTC_CR_BYPSHAD bit = 0, wait for synchro else this check is not
     * needed */
...
RTC_GetTime(uint32_t RTC_Format, RTC_TimeTypeDef* RTC_TimeStruct)
{
  ...
  RTC_TimeStruct->RTC_Minutes =
    (uint8_t)((tmpreg & (RTC_TR_MNT | RTC_TR_MNU)) >> 8);
  ...
  if (RTC_Format == RTC_Format_BIN)
  {
    ...
    RTC_TimeStruct->RTC_Hours =
      (uint8_t)RTC_Bcd2ToByte(RTC_TimeStruct->RTC_Hours);
    RTC_TimeStruct->RTC_Minutes =
      (uint8_t)RTC_Bcd2ToByte(RTC_TimeStruct->RTC_Minutes);
    RTC_TimeStruct->RTC_Seconds =
      (uint8_t)RTC_Bcd2ToByte(RTC_TimeStruct->RTC_Seconds);
  }
}
...
RTC_GetDate(uint32_t RTC_Format, RTC_DateTypeDef* RTC_DateStruct)
{
  ...
  RTC_DateStruct->RTC_Year =
    (uint8_t)((tmpreg & (RTC_DR_YT | RTC_DR_YU)) >> 16);
  RTC_DateStruct->RTC_Month =
    (uint8_t)((tmpreg & (RTC_DR_MT | RTC_DR_MU)) >> 8);
...
/**
  ...
  */
void
RTC_SetAlarm(uint32_t RTC_Format, uint32_t RTC_Alarm,
             RTC_AlarmTypeDef* RTC_AlarmStruct)
{
  ...
  if (RTC_Format == RTC_Format_BIN)
  {
    ...
    {
      assert_param(
        IS_RTC_ALARM_DATE_WEEKDAY_DATE(RTC_AlarmStruct->RTC_AlarmDateWeekDay));
    }
    else
    {
  ...
  {
    tmpreg =
      (((uint32_t)RTC_ByteToBcd2(RTC_AlarmStruct->RTC_AlarmTime.RTC_Hours)
        << 16) |
...
/**
  ...
  */
void
RTC_GetAlarm(uint32_t RTC_Format, uint32_t RTC_Alarm,
             RTC_AlarmTypeDef* RTC_AlarmStruct)
{
  uint32_t tmpreg = 0;
  ...
  RTC_AlarmStruct->RTC_AlarmTime.RTC_Hours =
    (uint32_t)((tmpreg & (RTC_ALRMAR_HT | RTC_ALRMAR_HU)) >> 16);
  RTC_AlarmStruct->RTC_AlarmTime.RTC_Minutes =
    (uint32_t)((tmpreg & (RTC_ALRMAR_MNT | RTC_ALRMAR_MNU)) >> 8);
  RTC_AlarmStruct->RTC_AlarmTime.RTC_Seconds =
    (uint32_t)(tmpreg & (RTC_ALRMAR_ST | RTC_ALRMAR_SU));
  RTC_AlarmStruct->RTC_AlarmTime.RTC_H12 =
    (uint32_t)((tmpreg & RTC_ALRMAR_PM) >> 16);
  RTC_AlarmStruct->RTC_AlarmDateWeekDay =
    (uint32_t)((tmpreg & (RTC_ALRMAR_DT | RTC_ALRMAR_DU)) >> 24);
  RTC_AlarmStruct->RTC_AlarmDateWeekDaySel =
    (uint32_t)(tmpreg & RTC_ALRMAR_WDSEL);
...
/**
  ...
  *                                          There is no comparison on sub
 * seconds for Alarm.
  *     @arg RTC_AlarmSubSecondMask_SS14_1 : SS[14:1] are don't care in Alarm
 * comparison.
  *                                          Only SS[0] is compared
  *     @arg RTC_AlarmSubSecondMask_SS14_2 : SS[14:2] are don't care in Alarm
 * comparison.
  *                                          Only SS[1:0] are compared
  *     @arg RTC_AlarmSubSecondMask_SS14_3 : SS[14:3] are don't care in Alarm
 * comparison.
  *                                          Only SS[2:0] are compared
  *     @arg RTC_AlarmSubSecondMask_SS14_4 : SS[14:4] are don't care in Alarm
 * comparison.
  *                                          Only SS[3:0] are compared
  *     @arg RTC_AlarmSubSecondMask_SS14_5 : SS[14:5] are don't care in Alarm
 * comparison.
  *                                          Only SS[4:0] are compared
  *     @arg RTC_AlarmSubSecondMask_SS14_6 : SS[14:6] are don't care in Alarm
 * comparison.
  *                                          Only SS[5:0] are compared
  *     @arg RTC_AlarmSubSecondMask_SS14_7 : SS[14:7] are don't care in Alarm
 * comparison.
  *                                          Only SS[6:0] are compared
  *     @arg RTC_AlarmSubSecondMask_SS14_8 : SS[14:8] are don't care in Alarm
 * comparison.
  *                                          Only SS[7:0] are compared
  *     @arg RTC_AlarmSubSecondMask_SS14_9 : SS[14:9] are don't care in Alarm
 * comparison.
  *                                          Only SS[8:0] are compared
  *     @arg RTC_AlarmSubSecondMask_SS14_10: SS[14:10] are don't care in Alarm
 * comparison.
  *                                          Only SS[9:0] are compared
  *     @arg RTC_AlarmSubSecondMask_SS14_11: SS[14:11] are don't care in Alarm
 * comparison.
  *                                          Only SS[10:0] are compared
  *     @arg RTC_AlarmSubSecondMask_SS14_12: SS[14:12] are don't care in Alarm
 * comparison.
  *                                          Only SS[11:0] are compared
  *     @arg RTC_AlarmSubSecondMask_SS14_13: SS[14:13] are don't care in Alarm
 * comparison.
  *                                          Only SS[12:0] are compared
  *     @arg RTC_AlarmSubSecondMask_SS14   : SS[14] is don't care in Alarm
 * comparison.
  *                                          Only SS[13:0] are compared
  *     @arg RTC_AlarmSubSecondMask_None   : SS[14:0] are compared and must
 * match
  *                                          to activate alarm
  * @retval None
  */
void
RTC_AlarmSubSecondConfig(uint32_t RTC_Alarm, uint32_t RTC_AlarmSubSecondValue,
                         uint32_t RTC_AlarmSubSecondMask)
{
  ...
  tmpreg = (uint32_t)(uint32_t)(RTC_AlarmSubSecondValue) |
           (uint32_t)(RTC_AlarmSubSecondMask);
...
/**
  ...
  *          This parameter can be one of the following values:
  *            @arg RTC_WakeUpClock_RTCCLK_Div16: RTC Wakeup Counter Clock =
 * RTCCLK/16
  *            @arg RTC_WakeUpClock_RTCCLK_Div8: RTC Wakeup Counter Clock =
 * RTCCLK/8
  *            @arg RTC_WakeUpClock_RTCCLK_Div4: RTC Wakeup Counter Clock =
 * RTCCLK/4
  *            @arg RTC_WakeUpClock_RTCCLK_Div2: RTC Wakeup Counter Clock =
 * RTCCLK/2
  *            @arg RTC_WakeUpClock_CK_SPRE_16bits: RTC Wakeup Counter Clock =
 * CK_SPRE
  *            @arg RTC_WakeUpClock_CK_SPRE_17bits: RTC Wakeup Counter Clock =
 * CK_SPRE
  * @retval None
  */
void
...
@verbatim
 ...
 [..] This section provide functions allowing to configure the RTC DayLight
Saving.
...
/**
  ...
  */
void
RTC_DayLightSavingConfig(uint32_t RTC_DayLightSaving,
...
@verbatim
 ...
 [..] This section provide functions allowing to configure the RTC Output
source.
...
/**
  ...
  * @param  Value: value of coarse calibration expressed in ppm (coded on 5
 * bits).
  *
 ...
 * negative
  ...
  *
  * @note   This Calibration value should be between 0 and 126 when using
 * positive
...
/**
  * @brief  Configure the Calibration Pinout (RTC_CALIB) Selection (1Hz or
 * 512Hz).
...
/**
  ...
  *   This parameter can be one of the following values:
  *     @arg RTC_SmoothCalibPlusPulses_Set  : Add one RTCCLK puls every 2**11
 * pulses.
                      ...
                      uint32_t RTC_SmouthCalibMinusPulsesValue)
{
  ...
  /* check if the calibration pending is completed or if there is no calibration
   * operation at all*/
  if ((RTC->ISR & RTC_ISR_RECALPF) == RESET)
  {
 ...
 * rising
  ...
  *            @arg RTC_TimeStampEdge_Falling: the Time stamp event occurs on
 * the
...
/**
  ...
  *   This parameter can be one of the following values:
  *     @arg RTC_TamperTrigger_RisingEdge: Rising Edge of the tamper pin causes
 * tamper event.
  *     @arg RTC_TamperTrigger_FallingEdge: Falling Edge of the tamper pin
 * causes tamper event.
  *     @arg RTC_TamperTrigger_LowLevel: Low Level of the tamper pin causes
 * tamper event.
  *     @arg RTC_TamperTrigger_HighLevel: High Level of the tamper pin causes
 * tamper event.
  * @retval None
  */
void
...
/**
  ...
  *   This parameter can be one of the following values:
  *     @arg RTC_TamperSamplingFreq_RTCCLK_Div32768: Each of the tamper inputs
 * are sampled
  *                                           with a frequency =  RTCCLK / 32768
  *     @arg RTC_TamperSamplingFreq_RTCCLK_Div16384: Each of the tamper inputs
 * are sampled
  *                                           with a frequency =  RTCCLK / 16384
  *     @arg RTC_TamperSamplingFreq_RTCCLK_Div8192: Each of the tamper inputs
 * are sampled
  *                                           with a frequency =  RTCCLK / 8192
  *     @arg RTC_TamperSamplingFreq_RTCCLK_Div4096: Each of the tamper inputs
 * are sampled
  *                                           with a frequency =  RTCCLK / 4096
  *     @arg RTC_TamperSamplingFreq_RTCCLK_Div2048: Each of the tamper inputs
 * are sampled
  *                                           with a frequency =  RTCCLK / 2048
  *     @arg RTC_TamperSamplingFreq_RTCCLK_Div1024: Each of the tamper inputs
 * are sampled
  *                                           with a frequency =  RTCCLK / 1024
  *     @arg RTC_TamperSamplingFreq_RTCCLK_Div512: Each of the tamper inputs are
 * sampled
  *                                           with a frequency =  RTCCLK / 512
  *     @arg RTC_TamperSamplingFreq_RTCCLK_Div256: Each of the tamper inputs are
 * sampled
...
/**
  ...
  *         Precharge Duration.
  *   This parameter can be one of the following values:
  *     @arg RTC_TamperPrechargeDuration_1RTCCLK: Tamper pins are precharged
 * before sampling during 1 RTCCLK cycle
  *     @arg RTC_TamperPrechargeDuration_2RTCCLK: Tamper pins are precharged
 * before sampling during 2 RTCCLK cycle
  *     @arg RTC_TamperPrechargeDuration_4RTCCLK: Tamper pins are precharged
 * before sampling during 4 RTCCLK cycle
  *     @arg RTC_TamperPrechargeDuration_8RTCCLK: Tamper pins are precharged
 * before sampling during 8 RTCCLK cycle
  * @retval None
  */
void
...
/** @defgroup RTC_Group11 RTC Tamper and TimeStamp Pins Selection and Output
Type Config configuration functions
...
/**
  ...
  *          This parameter can be one of the following values:
  *            @arg RTC_TimeStampPin_PC13: PC13 is selected as RTC TimeStamp
 * Pin.
...
/**
  ...
  * @note   When REFCKON is set, firmware must not write to Shift control
 * register
...
RTC_SynchroShiftConfig(uint32_t RTC_ShiftAdd1S, uint32_t RTC_ShiftSubFS)
{
  ...
  /* Check if the Shift pending is completed or if there is no Shift operation
   * at all*/
  if ((RTC->ISR & RTC_ISR_SHPF) == RESET)
  {
...
using
   ...
   (+) To enable the RTC Wakeup interrupt, the following sequence is required:
       (++) Configure and enable the EXTI Line 22 in interrupt mode and select
the
...
/**
  ...
  * @param  RTC_IT: specifies the RTC interrupt sources to be enabled or
 * disabled.
  *          This parameter can be any combination of the following values:
