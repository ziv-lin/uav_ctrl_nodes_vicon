...
function
  ...
  (#) At this stage you can read/write from/to the memory connected to the NAND
Bank.
...
/**
  * @brief  De-initializes the FSMC NAND Banks registers to their default reset
 * values.
  * @param  FSMC_Bank: specifies the FSMC Bank to be used
  *          This parameter can be one of the following values:
 ...
 * parameters
  ...
  * @param  FSMC_NANDInitStruct : pointer to a FSMC_NANDInitTypeDef structure
 * that
  *         contains the configuration information for the FSMC NAND specified
 * Banks.
  * @retval None
  */
void
...
@verbatim
 ...
 [..]  he following sequence should be followed to configure the FSMC to
interface
...
/**
  * @brief  De-initializes the FSMC PCCARD Bank registers to their default reset
 * values.
  * @param  None
  * @retval None
  */
 ...
 * structure
  *         that contains the configuration information for the FSMC PCCARD
 * Bank.
  * @retval None
  */
void
