...
#define VoltageRange_1                                                         \
  ((uint8_t)0x00) /*!< Device operating range: 1.8V to 2.1V */
#define VoltageRange_2                                                         \
  ((uint8_t)0x01) /*!<Device operating range: 2.1V to 2.7V */
#define VoltageRange_3                                                         \
  ((uint8_t)0x02) /*!<Device operating range: 2.7V to 3.6V */
#define VoltageRange_4                                                         \
  ((uint8_t)0x03) /*!<Device operating range: 2.7V to 3.6V + External Vpp */

#define IS_VOLTAGERANGE(RANGE)                                                 \
  (((RANGE) == VoltageRange_1) || ((RANGE) == VoltageRange_2) ||               \
   ((RANGE) == VoltageRange_3) || ((RANGE) == VoltageRange_4))
/**
  * @}
  */
...
/** @defgroup Option_Bytes_Write_Protection
  * @{
  */
#define OB_WRP_Sector_0                                                        \
  ((uint32_t)0x00000001) /*!< Write protection of Sector0     */
#define OB_WRP_Sector_1                                                        \
  ((uint32_t)0x00000002) /*!< Write protection of Sector1     */
#define OB_WRP_Sector_2                                                        \
  ((uint32_t)0x00000004) /*!< Write protection of Sector2     */
#define OB_WRP_Sector_3                                                        \
  ((uint32_t)0x00000008) /*!< Write protection of Sector3     */
#define OB_WRP_Sector_4                                                        \
  ((uint32_t)0x00000010) /*!< Write protection of Sector4     */
#define OB_WRP_Sector_5                                                        \
  ((uint32_t)0x00000020) /*!< Write protection of Sector5     */
#define OB_WRP_Sector_6                                                        \
  ((uint32_t)0x00000040) /*!< Write protection of Sector6     */
#define OB_WRP_Sector_7                                                        \
  ((uint32_t)0x00000080) /*!< Write protection of Sector7     */
#define OB_WRP_Sector_8                                                        \
  ((uint32_t)0x00000100) /*!< Write protection of Sector8     */
#define OB_WRP_Sector_9                                                        \
  ((uint32_t)0x00000200) /*!< Write protection of Sector9     */
#define OB_WRP_Sector_10                                                       \
  ((uint32_t)0x00000400) /*!< Write protection of Sector10    */
#define OB_WRP_Sector_11                                                       \
  ((uint32_t)0x00000800) /*!< Write protection of Sector11    */
#define OB_WRP_Sector_12                                                       \
  ((uint32_t)0x00000001) /*!< Write protection of Sector12    */
#define OB_WRP_Sector_13                                                       \
  ((uint32_t)0x00000002) /*!< Write protection of Sector13    */
#define OB_WRP_Sector_14                                                       \
  ((uint32_t)0x00000004) /*!< Write protection of Sector14    */
#define OB_WRP_Sector_15                                                       \
  ((uint32_t)0x00000008) /*!< Write protection of Sector15    */
#define OB_WRP_Sector_16                                                       \
  ((uint32_t)0x00000010) /*!< Write protection of Sector16    */
#define OB_WRP_Sector_17                                                       \
  ((uint32_t)0x00000020) /*!< Write protection of Sector17    */
#define OB_WRP_Sector_18                                                       \
  ((uint32_t)0x00000040) /*!< Write protection of Sector18    */
#define OB_WRP_Sector_19                                                       \
  ((uint32_t)0x00000080) /*!< Write protection of Sector19    */
#define OB_WRP_Sector_20                                                       \
  ((uint32_t)0x00000100) /*!< Write protection of Sector20    */
#define OB_WRP_Sector_21                                                       \
  ((uint32_t)0x00000200) /*!< Write protection of Sector21    */
#define OB_WRP_Sector_22                                                       \
  ((uint32_t)0x00000400) /*!< Write protection of Sector22    */
#define OB_WRP_Sector_23                                                       \
  ((uint32_t)0x00000800) /*!< Write protection of Sector23    */
#define OB_WRP_Sector_All                                                      \
  ((uint32_t)0x00000FFF) /*!< Write protection of all Sectors */
...
/*#define OB_RDP_Level_2   ((uint8_t)0xCC)*/ /*!< Warning: When enabling read
                                                protection level 2
                                                  it's no more possible to go
...
#define FLASH_FLAG_EOP                                                         \
  ((uint32_t)0x00000001) /*!< FLASH End of Operation flag               */
#define FLASH_FLAG_OPERR                                                       \
  ((uint32_t)0x00000002) /*!< FLASH operation Error flag                */
#define FLASH_FLAG_WRPERR                                                      \
  ((uint32_t)0x00000010) /*!< FLASH Write protected error flag          */
#define FLASH_FLAG_PGAERR                                                      \
  ((uint32_t)0x00000020) /*!< FLASH Programming Alignment error flag    */
#define FLASH_FLAG_PGPERR                                                      \
  ((uint32_t)0x00000040) /*!< FLASH Programming Parallelism error flag  */
#define FLASH_FLAG_PGSERR                                                      \
  ((uint32_t)0x00000080) /*!< FLASH Programming Sequence error flag     */
#define FLASH_FLAG_BSY                                                         \
  ((uint32_t)0x00010000) /*!< FLASH Busy flag                           */
#define IS_FLASH_CLEAR_FLAG(FLAG)                                              \
  ((((FLAG) & (uint32_t)0xFFFFFE0C) == 0x00000000) && ((FLAG) != 0x00000000))
