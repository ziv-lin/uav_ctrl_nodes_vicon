...
typedef struct
{
  ...
  uint32_t TIM_Period; /*!< Specifies the period value to be loaded into the
                          active
  ...
  uint8_t TIM_RepetitionCounter; /*!< Specifies the repetition counter value.
                                    ...
                                    and counting restarts
                                      ...
                                      This means in PWM mode that (N+1)
                                    corresponds to:
                                    ...
                                    0x00 and 0xFF.
                                      @note This parameter is valid only for
                                    TIM1 and TIM8. */
...
typedef struct
{
  ...
  uint16_t
    TIM_OCIdleState; /*!< Specifies the TIM Output Compare pin state during Idle
                        state.
                          This parameter can be a value of @ref
