...
{
  uint32_t
    RTC_HourFormat; /*!< Specifies the RTC Hour Format.
                    This parameter can be a value of @ref RTC_Hour_Formats */

  uint32_t
    RTC_AsynchPrediv; /*!< Specifies the RTC Asynchronous Predivider value.
                      This parameter must be set to a value lower than 0x7F */

  uint32_t
    RTC_SynchPrediv; /*!< Specifies the RTC Synchronous Predivider value.
...
typedef struct
{
  ...
  uint8_t
    RTC_Minutes; /*!< Specifies the RTC Time Minutes.
                 This parameter must be set to a value in the 0-59 range. */

  uint8_t
    RTC_Seconds; /*!< Specifies the RTC Time Seconds.
                 This parameter must be set to a value in the 0-59 range. */

  uint8_t
    RTC_H12; /*!< Specifies the RTC AM/PM Time.
...
typedef struct
{
  ...
  uint32_t RTC_AlarmDateWeekDaySel; /*!< Specifies the RTC Alarm is on Date or
                                    WeekDay.
                                    This parameter can be a value of @ref
...
#define IS_RTC_OUTPUT_POL(POL)                                                 \
  (((POL) == RTC_OutputPolarity_High) || ((POL) == RTC_OutputPolarity_Low))
/**
  * @}
  */
...
#define IS_RTC_CALIB_SIGN(SIGN)                                                \
  (((SIGN) == RTC_CalibSign_Positive) || ((SIGN) == RTC_CalibSign_Negative))
...
#define RTC_TamperFilter_Disable                                               \
  ((uint32_t)0x00000000) /*!< Tamper filter is disabled */

#define RTC_TamperFilter_2Sample                                               \
  ((uint32_t)0x00000800) /*!< Tamper is activated after 2                      \
                         consecutive samples at the active level */
#define RTC_TamperFilter_4Sample                                               \
  ((uint32_t)0x00001000) /*!< Tamper is activated after 4                      \
                         consecutive samples at the active level */
#define RTC_TamperFilter_8Sample                                               \
  ((uint32_t)0x00001800) /*!< Tamper is activated after 8                      \
...
#define RTC_TamperSamplingFreq_RTCCLK_Div32768                                 \
  ((uint32_t)0x00000000) /*!< Each of the tamper inputs are sampled            \
                             with a frequency =  RTCCLK / 32768 */
#define RTC_TamperSamplingFreq_RTCCLK_Div16384                                 \
  ((uint32_t)0x000000100) /*!< Each of the tamper inputs are sampled           \
                              with a frequency =  RTCCLK / 16384 */
#define RTC_TamperSamplingFreq_RTCCLK_Div8192                                  \
  ((uint32_t)0x00000200) /*!< Each of the tamper inputs are sampled            \
                             with a frequency =  RTCCLK / 8192  */
#define RTC_TamperSamplingFreq_RTCCLK_Div4096                                  \
  ((uint32_t)0x00000300) /*!< Each of the tamper inputs are sampled            \
                             with a frequency =  RTCCLK / 4096  */
#define RTC_TamperSamplingFreq_RTCCLK_Div2048                                  \
  ((uint32_t)0x00000400) /*!< Each of the tamper inputs are sampled            \
                             with a frequency =  RTCCLK / 2048  */
#define RTC_TamperSamplingFreq_RTCCLK_Div1024                                  \
  ((uint32_t)0x00000500) /*!< Each of the tamper inputs are sampled            \
                             with a frequency =  RTCCLK / 1024  */
#define RTC_TamperSamplingFreq_RTCCLK_Div512                                   \
  ((uint32_t)0x00000600) /*!< Each of the tamper inputs are sampled            \
                             with a frequency =  RTCCLK / 512   */
#define RTC_TamperSamplingFreq_RTCCLK_Div256                                   \
  ((uint32_t)0x00000700) /*!< Each of the tamper inputs are sampled            \
...
#define RTC_TamperPrechargeDuration_1RTCCLK                                    \
  ((uint32_t)0x00000000) /*!< Tamper pins are pre-charged before               \
                              sampling during 1 RTCCLK cycle */
#define RTC_TamperPrechargeDuration_2RTCCLK                                    \
  ((uint32_t)0x00002000) /*!< Tamper pins are pre-charged before               \
                              sampling during 2 RTCCLK cycles */
#define RTC_TamperPrechargeDuration_4RTCCLK                                    \
  ((uint32_t)0x00004000) /*!< Tamper pins are pre-charged before               \
                              sampling during 4 RTCCLK cycles */
#define RTC_TamperPrechargeDuration_8RTCCLK                                    \
  ((uint32_t)0x00006000) /*!< Tamper pins are pre-charged before               \
...
#define IS_RTC_OUTPUT_TYPE(TYPE)                                               \
  (((TYPE) == RTC_OutputType_OpenDrain) || ((TYPE) == RTC_OutputType_PushPull))
...
#define IS_RTC_CLEAR_FLAG(FLAG)                                                \
  (((FLAG) != (uint32_t)RESET) && (((FLAG)&0xFFFF00DF) == (uint32_t)RESET))
/**
  * @}
  */
...
#define RTC_IT_TAMP                                                            \
  ((uint32_t)0x00000004) /* Used only to Enable the Tamper Interrupt */
#define RTC_IT_TAMP1 ((uint32_t)0x00020000)

#define IS_RTC_CONFIG_IT(IT)                                                   \
  (((IT) != (uint32_t)RESET) && (((IT)&0xFFFF0FFB) == (uint32_t)RESET))
#define IS_RTC_GET_IT(IT)                                                      \
  (((IT) == RTC_IT_TS) || ((IT) == RTC_IT_WUT) || ((IT) == RTC_IT_ALRB) ||     \
   ((IT) == RTC_IT_ALRA) || ((IT) == RTC_IT_TAMP1))
