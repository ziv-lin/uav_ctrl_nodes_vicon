...
typedef struct
{
  ...
  uint8_t
    CAN_Mode; /*!< Specifies the CAN operating mode.
  ...
  FunctionalState
    CAN_NART; /*!< Enable or disable the non-automatic retransmission mode.
                   This parameter can be set either to ENABLE or DISABLE. */
...
typedef struct
{
  ...
  uint16_t CAN_FilterMaskIdHigh; /*!< Specifies the filter mask number or
                                    identification number,
                                          according to the mode (MSBs for a
  ...
  uint16_t CAN_FilterMaskIdLow; /*!< Specifies the filter mask number or
                                   identification number,
                                         according to the mode (LSBs for a
                                   32-bit configuration,
...
#define CAN_InitStatus_Failed                                                  \
  ((uint8_t)0x00)                              /*!< CAN initialization failed  \
                                                  */
...
#define CAN_ErrorCode_BitDominantErr                                           \
  ((uint8_t)0x50)                            /*!< Bit Dominant Error           \
                                                */
#define CAN_ErrorCode_CRCErr ((uint8_t)0x60) /*!< CRC Error  */
#define CAN_ErrorCode_SoftwareSetErr                                           \
  ((uint8_t)0x70) /*!< Software Set Error                                      \
                     */
/**
  * @}
  */
...
#define CAN_FLAG_FMP0                                                          \
  ((uint32_t)0x12000003)                     /*!< FIFO 0 Message Pending Flag  \
                                                */
#define CAN_FLAG_FF0 ((uint32_t)0x32000008)  /*!< FIFO 0 Full Flag */
#define CAN_FLAG_FOV0 ((uint32_t)0x32000010) /*!< FIFO 0 Overrun Flag */
#define CAN_FLAG_FMP1                                                          \
  ((uint32_t)0x14000003)                     /*!< FIFO 1 Message Pending Flag  \
                                                */
