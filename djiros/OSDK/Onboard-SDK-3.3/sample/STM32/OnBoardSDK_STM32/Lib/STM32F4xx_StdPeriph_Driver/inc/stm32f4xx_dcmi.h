/**
  ...
  * @brief   This file contains all the functions prototypes for the DCMI
  *firmware library.
  ******************************************************************************
  * @attention
  *
...
typedef struct
{
  uint16_t DCMI_CaptureMode; /*!< Specifies the Capture Mode: Continuous or
                                Snapshot.
                                  This parameter can be a value of @ref
                                DCMI_Capture_Mode */

  uint16_t DCMI_SynchroMode; /*!< Specifies the Synchronization Mode: Hardware
                                or Embedded.
                                  This parameter can be a value of @ref
                                DCMI_Synchronization_Mode */

  uint16_t DCMI_PCKPolarity; /*!< Specifies the Pixel clock polarity: Falling or
                                Rising.
                                  This parameter can be a value of @ref
                                DCMI_PIXCK_Polarity */

  uint16_t DCMI_VSPolarity; /*!< Specifies the Vertical synchronization
                               polarity: High or Low.
                                 This parameter can be a value of @ref
                               DCMI_VSYNC_Polarity */

  uint16_t DCMI_HSPolarity; /*!< Specifies the Horizontal synchronization
                               polarity: High or Low.
                                 This parameter can be a value of @ref
                               DCMI_HSYNC_Polarity */

  uint16_t DCMI_CaptureRate; /*!< Specifies the frequency of frame capture: All,
                                1/2 or 1/4.
                                  This parameter can be a value of @ref
                                DCMI_Capture_Rate */

  uint16_t DCMI_ExtendedDataMode; /*!< Specifies the data width: 8-bit, 10-bit,
                                     12-bit or 14-bit.
                                       This parameter can be a value of @ref
...
typedef struct
{
  uint16_t DCMI_VerticalStartLine; /*!< Specifies the Vertical start line count
                                      from which the image capture
                                        will start. This parameter can be a
                                      value between 0x00 and 0x1FFF */

  uint16_t DCMI_HorizontalOffsetCount; /*!< Specifies the number of pixel clocks
                                          to count before starting a capture.
                                            This parameter can be a value
                                          between 0x00 and 0x3FFF */

  uint16_t DCMI_VerticalLineCount; /*!< Specifies the number of lines to be
                                      captured from the starting point.
                                        This parameter can be a value between
                                      0x00 and 0x3FFF */

  uint16_t DCMI_CaptureCount; /*!< Specifies the number of pixel clocks to be
                                 captured from the starting
                                   point on the same line.
                                   This parameter can be a value between 0x00
                                 and 0x3FFF */
...
typedef struct
{
  uint8_t DCMI_FrameStartCode; /*!< Specifies the code of the frame start
                                  delimiter. */
  uint8_t
    DCMI_LineStartCode; /*!< Specifies the code of the line start delimiter. */
  uint8_t
    DCMI_LineEndCode; /*!< Specifies the code of the line end delimiter. */
  uint8_t
    DCMI_FrameEndCode; /*!< Specifies the code of the frame end delimiter. */
...
#define DCMI_CaptureMode_SnapShot                                              \
  ((uint16_t)0x0002) /*!< Once activated, the interface waits for the start    \
                        of                                                     \
                          frame and then transfers a single frame through      \
                        the DMA */
...
#define DCMI_SynchroMode_Hardware                                              \
  ((uint16_t)0x0000) /*!< Hardware synchronization data capture (frame/line    \
                        start/stop)                                            \
                          is synchronized with the HSYNC/VSYNC signals */
#define DCMI_SynchroMode_Embedded                                              \
  ((uint16_t)0x0010) /*!< Embedded synchronization data capture is             \
                        synchronized with                                      \
...
#define DCMI_VSPolarity_Low                                                    \
  ((uint16_t)0x0000) /*!< Vertical synchronization active Low */
...
#define IS_DCMI_HSPOLARITY(POLARITY)                                           \
  (((POLARITY) == DCMI_HSPolarity_Low) || ((POLARITY) == DCMI_HSPolarity_High))
/**
  * @}
  */
...
#define DCMI_CaptureRate_All_Frame                                             \
  ((uint16_t)0x0000) /*!< All frames are captured */
#define DCMI_CaptureRate_1of2_Frame                                            \
  ((uint16_t)0x0100) /*!< Every alternate frame captured */
...
#define DCMI_ExtendedDataMode_8b                                               \
  ((uint16_t)0x0000) /*!< Interface captures 8-bit data on every pixel clock   \
                        */
#define DCMI_ExtendedDataMode_10b                                              \
  ((uint16_t)0x0400) /*!< Interface captures 10-bit data on every pixel clock  \
                        */
#define DCMI_ExtendedDataMode_12b                                              \
  ((uint16_t)0x0800) /*!< Interface captures 12-bit data on every pixel clock  \
                        */
#define DCMI_ExtendedDataMode_14b                                              \
  ((uint16_t)0x0C00) /*!< Interface captures 14-bit data on every pixel clock  \
                        */
...
#define IS_DCMI_GET_IT(IT)                                                     \
  (((IT) == DCMI_IT_FRAME) || ((IT) == DCMI_IT_OVF) ||                         \
   ((IT) == DCMI_IT_ERR) || ((IT) == DCMI_IT_VSYNC) || ((IT) == DCMI_IT_LINE))
/**
  * @}
  */
...
#define IS_DCMI_GET_FLAG(FLAG)                                                 \
  (((FLAG) == DCMI_FLAG_HSYNC) || ((FLAG) == DCMI_FLAG_VSYNC) ||               \
   ...
   ((FLAG) == DCMI_FLAG_OVFRI) || ((FLAG) == DCMI_FLAG_ERRRI) ||               \
   ((FLAG) == DCMI_FLAG_VSYNCRI) || ((FLAG) == DCMI_FLAG_LINERI) ||            \
   ((FLAG) == DCMI_FLAG_FRAMEMI) || ((FLAG) == DCMI_FLAG_OVFMI) ||             \
   ((FLAG) == DCMI_FLAG_ERRMI) || ((FLAG) == DCMI_FLAG_VSYNCMI) ||             \
