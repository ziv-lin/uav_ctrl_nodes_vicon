                                    ...
                                    UserData userData)
{
  ...
  HotpointMission::getHotpointSettingsCallback(
    vehicle, recvFrame, vehicle->missionManager->hpMission);
...
{
  vehicle->missionManager->hpMission->getHotpointSettings(hotpointReadCallback,
                                                          this);
}
