...
WaypointMission::getWaypointSettings(int timer)
{
  ...
  vehicle->protocolLayer->send(2, encrypt,
                               OpenProtocol::CMDSet::Mission::waypointDownload,
                               &arbNumber, sizeof(arbNumber), 1000, 4, 0, 0);
                                     ...
                                     UserData        userData)
{
  ...
  vehicle->protocolLayer->send(
    2, encrypt, OpenProtocol::CMDSet::Mission::waypointDownload, &arbNumber,
...
WaypointMission::getIndex(uint8_t index, int timer)
{
  ...
  vehicle->protocolLayer->send(
    2, encrypt, OpenProtocol::CMDSet::Mission::waypointIndexDownload, &index,
