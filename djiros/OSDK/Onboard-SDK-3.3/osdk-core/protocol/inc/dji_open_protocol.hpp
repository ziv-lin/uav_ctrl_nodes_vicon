...
public:
  ...
  //! Get the bufReadPos variable that tracks how much of the current serial
  //! buffer we have consumed
  int getBufReadPos();
  //! Get the readLen variable that tracks how many bytes were last read from
  //! the serialDevice
  int getReadLen();
